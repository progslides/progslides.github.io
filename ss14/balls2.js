...
function Ball(game, x, y, radius, dir, speed, bid) {
 this.x = x;
 this.y = y;
...
this.addBall = function(nr, x, y, spd, dir) {
  var ball = '<span class="pln">  </span><span class="typ">Ball</span><span class="pln"> b' + nr +'</span><span class="pun">(</span><span class="lit">' + x + '</span><span class="pun">,</span><span class="pln"> </span><span class="lit">' + y + '</span><span class="pun">,</span><span class="pln"> </span><span class="lit">' + spd + '</span><span class="pun">,</span><span class="pln"> </span><span class="lit">' + dir + '</span><span class="pun">,</span> <span class="str">"#' + nr + '"</span><span class="pun">);</span><span class="pln">\n</span><span class="pln">  balls</span><span class="pun">.</span><span class="pln">push_back</span><span class="pun">(</span><span class="pln">b' + nr + '</span><span class="pun">);</span>\n';
...
this.addRandomBall = function() {
  ...
  Example2.addBall(Example2.b_id, x, y, spd, dir);
  Example2.balls.push(new Ball(Example2.g, x, y, 16, dir, spd, Example2.b_id));  
};
